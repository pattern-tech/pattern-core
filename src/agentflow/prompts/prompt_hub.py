...
- <Important> Pay attention to input_schema of the tool and the user input to make sure the input_data is fully compatible with the input_schema </Important>
- You should send the input_data to the `retrieve_information` tool in the format of input_schema
...
- Only ask for clarification when essential parameters are missing or there is **critical ambiguity** that could lead to incorrect tool usage.
